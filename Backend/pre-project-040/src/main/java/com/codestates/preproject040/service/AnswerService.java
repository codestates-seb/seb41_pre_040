...
public class AnswerService {
    ...
    public AnswerDto createAnswer(AnswerDto dto) /* , UserAccount userAccount */ {
    ...
    /*public Answer updateAnswer(AnswerDto dto) {
        // 게시글 확인
    ...
    /*public void deleteAnswer(Long questionId, String userId) *//* , UserAccount userAccount *//* {   // 인증된 유저랑 같이 받기.
        // 게시글 확인.
