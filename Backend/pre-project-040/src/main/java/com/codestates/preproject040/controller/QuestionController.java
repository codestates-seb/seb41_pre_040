...
import com.codestates.preproject040.dto.Hashtag.HashtagSaveDto;
...
public class QuestionController {
    ...
    public ResponseEntity patchQuestion(@PathVariable("questionId") @Positive long id,
        ...
        Question question =
                QuestionDto.of(requestBody.title(), requestBody.questionHashtag(), requestBody.content1(), requestBody.content2())
