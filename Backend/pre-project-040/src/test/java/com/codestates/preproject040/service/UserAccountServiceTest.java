...
class UserAccountServiceTest {
    ...
    void givenExistentUserId_whenSearching_thenReturnsOptionalUserData() {
        ...
        // When
        Optional<UserAccountDto> result = sut.findUser(username);
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("juno");
        UserAccount savedUserAccount = createSigningUpUserAccount("juno");
